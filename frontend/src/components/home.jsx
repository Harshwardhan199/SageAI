    ...
    <>
      <div className="flex min-h-screen bg-[#151515]">
        ...
        <div className="fixed flex top-0 left-0 border-r border-r-[#151515] overflow-visible z-1">
          <div
            className={`flex flex-col h-screen items-center py-1 gap-3 bg-[#070707] ${!toggleSidebar ? "w-[58px]" : "w-[301px]"} text-white overflow-visible whitespace-nowrap transition-all duration-300 ease-in-out`}
            ref={refSidebar}
            ...
            <div className="flex flex-col item-center h-full w-full rounded-xl bg-[#070707] p-2 gap-1 overflow-visible">
              ...
              <div className="flex items-center justify-between h-[55px] w-full rounded-xl bg-[#070707] pb-4 gap-2 overflow-hidden">
                <div className="flex flex-shrink-0 justify-center w-[40px] relative">
                  ...
                  <div
                    className={`flex items-center absolute top-[-14px] transition-all duration-200 ease-in-out ${sidebarHover ? "opacity-100 scale-100" : "opacity-0 scale-90"}`}
                  >
                    <img
                      src="https://img.icons8.com/?size=100&id=xaWB0HfoyY9X&format=png&color=5A5A5A"
                      alt="left sidebar"
                      className="invert rounded-full w-[25px] h-[auto]"
              ...
              <div className="flex w-full mb-1">
                <div
                  className="flex item-center gap-2 h-[40px] w-full rounded-lg bg-[#155dfc] p-2 text-white overflow-hidden whitespace-nowrap"
                ...
                >
                  ...
                  <div
                    className={`transition-all duration-200 ease-in-out ${!toggleSidebar ? "opacity-0" : "opacity-100"}`}
                  >
                    New Chat
                  </div>
                </div>
              ...
              <div
                className={`transition-all duration-200 ease-in-out overflow-visible whitespace-nowrap ${!toggleSidebar ? "opacity-0" : "opacity-100"}`}
              >
                {/* Search Bar */}
                ...
                {/* Folder */}
                <div
                  className={`flex item-center justify-between w-full rounded-xl bg-[#070707] py-2 text-sm mt-[10px]`}
                >
                  <div>Folders</div>
                ...
                {/* Folders List */}
                <div
                  className={`flex flex-col gap-1 w-full rounded-lg overflow-visible transition-all duration-300 ease-in-out ${showFolders ? "opacity-100" : "opacity-0"}`}
                  style={{ height: foldersWindowHeight }}
                >
                  {folders.length == 0 && (
                    <div className="flex w-full mb-1">
                      <div
                        className="flex item-center gap-2 h-[40px] w-full rounded-lg bg-[#1f1f1f] p-2 text-white overflow-hidden whitespace-nowrap"
                        onClick={CreateFolderPopup}
                      >
                        <div className="flex items-center flex-shrink-0">
                          <img
                  ...
                  {folders.map((folder) => {
                    ...
                    const folderChatsWindowHeight = isOpen
                      ? `${chatsCount * 40 + (chatsCount - 0) * 4}px`
                      : "0px";
                    ...
                    return (
                      <div key={folder._id}>
                          ...
                          <div className="flex item-center justify-between ml-[5px] rounded-r-lg bg-[#1f1f1f] overflow-visible">
                            <div className="flex gap-2 p-2">
                              <div className="flex items-center">
                                <img
                                  src={`${isOpen ? "https://img.icons8.com/?size=100&id=82790&format=png&color=ffffff" : "https://img.icons8.com/?size=100&id=82843&format=png&color=cccccc"}`}
                                  alt="Folder"
                            ...
                            >
                              ...
                              {folderMenuId === folder._id && (
                                <div
                                  className="menu-container absolute -left-[15px] top-full flex flex-col gap-1 p-1 bg-[#272727] border-1 border-[#393939] drop-shadow rounded-lg z-1"
                                  ref={folderMenuRef}
                        ...
                        {/* Folder's Chat */}
                        <div
                          className={`flex flex-col item-center w-full pl-3 transition-all duration-200 ease-in-out ${isOpen ? "opacity-100" : "opacity-0 overflow-hidden"}`}
                          style={{ height: folderChatsWindowHeight }}
                        >
                          {folder.chats.map((chat) => (
                            <div
                              className="flex flex-col item-center justify-between w-full rounded-lg bg-[#272727] gap-1 mt-1 overflow-visible group/chat"
                              key={chat._id}
                            ...
                            >
                              <div className="flex justify-between gap-2 overflow-visible">
                                ...
                                >
                                  ...
                                  {chatMenuId === chat._id && (
                                    <div
                                      className="menu-container absolute -left-[15px] top-full flex flex-col gap-1 min-w-23 p-1 bg-[#272727] border-1 border-[#393939] drop-shadow rounded-lg z-1"
                                      ref={chatMenuRef}
                                      onClick={(e) => e.stopPropagation()}
                                    >
                                      <div className="px-3 py-1 rounded-lg hover:bg-[#323232]">
                ...
                {chats.length > 0 && (
                  <div
                    className={`flex item-center justify-between w-full rounded-xl bg-[#070707] py-2 text-sm transition-all duration-100 ease-in-out ${showFolders ? "mt-[10px]" : "mt-[0px]"}`}
                  >
                    <div>Chats</div>
                    <div className="flex item-center justify-center gap-1">
                      <button
              ...
              {/* Chats List */}
              <div
                className={`overflow-visible transition-all duration-200 ease-in-out ${showChats ? "opacity-100" : "opacity-0"}`}
                style={{ height: chatsWindowHeight }}
              >
                <div
                  className={`flex flex-col gap-1 item-center w-full transition-all duration-300 ease-in-out overflow-visible whitespace-nowrap ${!toggleSidebar ? "opacity-0" : "opacity-100"}`}
                >
                  {chats.map((chat) => (
                    <div
                    ...
                    >
                      <div className="flex justify-between gap-2 overflow-visible">
                        ...
                        >
                          ...
                          {chatMenuId === chat._id && (
                            <div
                              className="menu-container absolute -left-[15px] top-full flex flex-col gap-1 min-w-23 p-1 bg-[#272727] border-1 border-[#393939] drop-shadow rounded-lg z-5"
                              ref={chatMenuRef}
                              onClick={(e) => e.stopPropagation()}
                            >
                              <div className="px-3 py-1 rounded-lg hover:bg-[#323232]">
              ...
              {user && (
                <div
                  className={`absolute left-0 bottom-0 flex items-center w-full py-1 pl-[4px] border-t-1 border-[#272727] gap-2 bg-[#070707] transition-all duration-200 ease-in-out overflow-visible whitespace-nowrap ${toggleSidebar ? "w-[268px]" : "w-[58px]"}`}
                >
                  <div className="relative flex overflow-visible w-full">
                    <div
                      className="flex items-center justify-center h-[35px] w-[35px]  rounded-full m-2 bg-[#323232] flex-shrink-0"
                    ...
                    {showProfileMenu && (
                      <div className="absolute left-0 bottom-[calc(100%+4px)] flex flex-col gap-1 w-full p-1 drop-shadow z-30">
                        ...
                        <div
                          className="flex items-center justify-start h-[48px] p-1 bg-[#272727] border border-[#393939] rounded-sm"
                    ...
                    {/* onClick={getName} */}
                    <div
                      className={`${toggleSidebar ? "opacity-100 w-auto" : "opacity-0 w-0"} overflow-hidden transition-all duration-300`}
                    >
        ...
        {/* Mainarea */}
        <div
          className={`relative flex flex-1 flex-col items-center justify-center min-h-screen  bg-black ${!toggleSidebar ? "ml-[58px]" : "ml-[301px]"} transition-all duration-300 ease-in-out`}
        >
          {/* TitleBar [#161616] */}
          <div
            className="sticky top-0 flex w-full justify-between text-white pt-4 pr-8 pb-4 bg-[#030303] border-b border-b-[#151515] z-2"
            ref={titleBarRef}
          >
              ...
              <div className="flex items-center gap-3">
                <button className="relative h-[20px]">
                  <img
                    ...
                    alt="Saved prompts"
                    className="invert w-[20px] h-auto"
                  ...
                  {showSavedPrompts && (
                    <div className="absolute right-0 top-[calc(100%+4px)] flex flex-col min-w-40 max-w-60 gap-1 text-left rounded-lg bg-[#141414] border-2 border-[#212121] drop-shadow">
                      <div className="font-bold mt-2 ml-2 text-center">
                        Saved Prompts
                      </div>
                      ...
                      {savedPrompts.length > 0 && (
                        <div>
                              ...
                              >
                                <div className="flex items-center gap-2 min-w-0">
                                  <img
                                    ...
                                    onClick={() =>
                                      TogglePinPrompt(promptData._id)
                                    }
                                  />
                          ...
                          <div className="w-full h-[1px] bg-gray-300"></div>
                          <div className="ml-2 mr-2 mb-2 text-sm text-center">
                            Manage all
                          </div>
                        </div>
                      )}
          ...
          <div className="flex flex-col w-full flex-1 mt-[1px] items-center justify-center px-2 overflow-y-auto z-1">
            <div
              className={`flex max-w-[780px] w-full min-w-[600px] h-min-[500px] rounded-2xl flex-grow-0 overflow-hidden ${messages.length == 0 ? "bg-[#161616]" : "h-full bg-transparent"}`}
            >
              <div
                className={`flex flex-col w-full px-2 pt-4 pb-2 gap-0 flex-grow overflow-y-auto ${messages.length == 0 ? "items-center justify-start" : ""}`}
                ref={containerRef}
              >
                {messages.length == 0 && (
                  <div>
                    <div
                      className="flex flex-col items-center justify-center w-full gap-2 p-8 text-center mt-[10px]"
                      ref={searchBarRef}
                    >
                      <div>
                        <img
                      ...
                      <div className="text-[11.5px] text-[#969696]">
                        This code will display a prompt asking the user for
                        their name, and then it will display a greeting message
                    ...
                    <div className="flex items-center justify-center gap-2 text-center text-[10px] text-[#969696] mt-[10px]">
                      <div className="flex flex-col  h-[130px] w-[160px] p-3 rounded-xl bg-[#2d2d2d] gap-1">
                        ...
                        <div>
                          User saves and reuse prompt templates for faster
                          responses.
                        </div>
                      </div>
                      ...
                      <div className="relative w-full rounded-lg bg-white text-black">
                        ...
                        <div className="absolute top-[10px] right-[40px]">
                          <img
                            ...
                            alt="Logo"
                            className="rounded-full w-[18px] h-auto"
                          />
                        </div>
                        ...
                        <div className="absolute top-[4px] right-[4px] bg-blue-600 p-1 rounded-lg">
                          <img
                            ...
                            alt="Send prompt"
                            className="invert rounded-full w-[24px] h-auto"
          ...
          {messages.length > 0 && (
            <div
              className="sticky bottom-0 flex flex-col items-center w-full h-17 bg-black z-2"
              ref={searchBarRef}
            >
        ...
        {folderPopup && (
          <>
            ...
            <div
              ...
              onClick={() => setFolderPopup(!folderPopup)}
            ></div>
            ...
            <div className="fixed top-1/2 left-1/2 h-auto w-[400px] z-50 bg-[#191919] rounded-2xl shadow-gray-500 flex flex-col transform -translate-x-1/2 -translate-y-1/2 text-white">
              <div className="relative flex flex-col gap-5 px-10 py-10">
                ...
                <div className="flex justify-center w-full ">
                  <button
                    className="px-2 py-[1px] mt-[10px] rounded-lg bg-[#155dfc] text-[18px]"
